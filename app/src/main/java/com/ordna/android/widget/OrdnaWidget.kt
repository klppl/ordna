...
import com.ordna.android.data.repository.WidgetSettings
...
class RefreshWidgetAction : ActionCallback {
    override suspend fun onAction(context: Context, glanceId: GlanceId, parameters: ActionParameters) {
        try {
            ...
            com.ordna.android.data.repository.TaskRepository.syncForWidget(context)
        } catch (_: Exception) {
            // Fall back to async WorkManager sync
            val workRequest = OneTimeWorkRequestBuilder<com.ordna.android.data.sync.SyncWorker>().build()
