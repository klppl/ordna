...
Ordna shows overdue and due-today tasks. No projects, no priorities, no tags. If it's not due today, it's not on your screen.

The backend is Google Tasks. Your tasks live next to your Google Calendar, you can add them from Gmail, and you don't need another account. If you stop using Ordna, your tasks are still in Google.
